...
//    @Operation(summary = "Get booking history of a user", description = "Retrieve the booking history for a user")
...
//        List<BookingDto> bookingHistory = userService.getUserBookingHistory(id);
